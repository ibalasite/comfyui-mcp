...
start "AudioLDM2" cmd /k "cd /d C:\comfyuimcp && python audio_server.py"

echo [2/2] Starting ComfyUI on :8188 ...
echo NOTE: Edit the path below to match your ComfyUI install location.
start "ComfyUI" cmd /k "cd /d C:\ComfyUI && python main.py --listen 127.0.0.1 --port 8188 --preview-method auto"
